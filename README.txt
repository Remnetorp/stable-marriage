...
Run the program by first compiling and then either of the following lines, depending if you want extra output or not: 
(1) $ javac StableMarriage.java
(2) $ java StableMarriage.java < data-input/input1.in 
(3) $ java StableMarriage.java < data-input/input1.in output 
